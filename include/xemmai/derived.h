...
struct t_derived : T
{
	...
	virtual void f_plus(t_object* a_this);
	virtual void f_minus(t_object* a_this);
	virtual void f_not(t_object* a_this);
	virtual void f_complement(t_object* a_this);
	virtual void f_multiply(t_object* a_this);
	virtual void f_divide(t_object* a_this);
	virtual void f_modulus(t_object* a_this);
	virtual void f_add(t_object* a_this);
	virtual void f_subtract(t_object* a_this);
	virtual void f_left_shift(t_object* a_this);
	virtual void f_right_shift(t_object* a_this);
	...
	virtual void f_and(t_object* a_this);
	virtual void f_xor(t_object* a_this);
	virtual void f_or(t_object* a_this);
