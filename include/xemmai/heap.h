#ifndef XEMMAI__HEAP_H
#define XEMMAI__HEAP_H
...
class t_heap
{
	...
	static inline XEMMAI__PORTABLE__THREAD T* v_head;
	...
	static XEMMAI__PORTABLE__ALWAYS_INLINE T* f_allocate()
	{
		auto p = v_head<A_rank>;
...
public:
	...
	template<auto A_heap>
	static XEMMAI__PORTABLE__ALWAYS_INLINE T* f_allocate(size_t a_size)
	{
