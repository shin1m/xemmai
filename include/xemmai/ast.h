...
public:
	...
	virtual ~t_node();
	virtual size_t f_generate(t_generator& a_generator, size_t a_stack, bool a_tail) = 0;
};
...
struct t_lambda : t_node, t_scope
{
	...
	virtual size_t f_generate(t_generator& a_generator, size_t a_stack, bool a_tail);
};
