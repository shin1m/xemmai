...
#define XEMMAI__MACRO__IS(n) if (!f_is<T_a##n>(stack->f_at(XEMMAI__MACRO__N - 1 - n))) return false;
...
{
	static void f_call(t_transfer (*a_function)(t_object* XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__), t_object* a_class, size_t a_n)
	{
		...
		stack->f_return(a_function(a_class XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AS_AN__));
	}
	static void f_call(t_transfer (*a_function)(t_object* XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__), t_object* a_class)
	{
		t_stack* stack = f_stack();
		XEMMAI__MACRO__REVERSE_REPEAT(XEMMAI__MACRO__POP, XEMMAI__MACRO__N)
		stack->f_return(a_function(a_class XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AS_AN__));
	}
	static bool f_match(size_t a_n)
	{
...
struct t_construct<T_self XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__ XEMMAI__MACRO__COMMA_UNSPECIFIED__, t_unspecified>
{
	...
	{
		t_type::f_call(f_default, a_class, a_n);
	}
	static void f_call(t_object* a_class)
	{
		t_type::f_call(f_default, a_class);
	}
};
...
struct XEMMAI__MACRO__CALL_MEMBERN
{
	...
	{
		template<typename T_function>
		static void f_call(T_function a_function, t_object* a_module, const t_value& a_self, size_t a_n)
		{
			...
			XEMMAI__MACRO__REVERSE_REPEAT(XEMMAI__MACRO__POP, XEMMAI__MACRO__N)
			XEMMAI__MACRO__REPEAT(XEMMAI__MACRO__CHECK, XEMMAI__MACRO__N)
			stack->f_return(XEMMAI__MACRO__CALL_MEMBERN_WITH<T_extension, T_self XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__, A_function, A_void, A_extension, T_with>::f_call(a_function, a_module, a_self XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AN__));
		}
		template<typename T_function>
		static void f_call(T_function a_function, t_object* a_module, const t_value& a_self)
		{
			t_stack* stack = f_stack();
			XEMMAI__MACRO__REVERSE_REPEAT(XEMMAI__MACRO__POP, XEMMAI__MACRO__N)
			stack->f_return(XEMMAI__MACRO__CALL_MEMBERN_WITH<T_extension, T_self XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__, A_function, A_void, A_extension, T_with>::f_call(a_function, a_module, a_self XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AN__));
	...
	static bool f_match(const t_value& a_self, size_t a_n)
	{
...
struct XEMMAI__MACRO__CALL_STATICN
{
	...
	{
		template<typename T_function>
		static void f_call(T_function a_function, t_object* a_module, size_t a_n)
		{
			if (a_n != XEMMAI__MACRO__N) t_throwable::f_throw(L"must be called with " XEMMAI__MACRO__L(XEMMAI__MACRO__N) L" argument(s).");
			t_stack* stack = f_stack();
			XEMMAI__MACRO__REVERSE_REPEAT(XEMMAI__MACRO__POP, XEMMAI__MACRO__N)
			XEMMAI__MACRO__REPEAT(XEMMAI__MACRO__CHECK, XEMMAI__MACRO__N)
			stack->f_return(XEMMAI__MACRO__CALL_STATICN_WITH<T_extension XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__, A_void, A_extension>::f_call(a_function, f_extension<T_extension>(a_module) XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AN__));
		}
		template<typename T_function>
		static void f_call(T_function a_function, t_object* a_module)
		{
			t_stack* stack = f_stack();
			XEMMAI__MACRO__REVERSE_REPEAT(XEMMAI__MACRO__POP, XEMMAI__MACRO__N)
			stack->f_return(XEMMAI__MACRO__CALL_STATICN_WITH<T_extension XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__T_AN__, A_void, A_extension>::f_call(a_function, a_module XEMMAI__MACRO__COMMA_IF_N XEMMAI__MACRO__AN__));
		}
	};
