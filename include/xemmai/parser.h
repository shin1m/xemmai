...
class XEMMAI__LOCAL t_parser
{
	...
	bool f_argument(size_t a_depth, size_t a_head, size_t a_indent, std::vector<std::unique_ptr<ast::t_node>>& a_nodes);
	bool f_arguments(size_t a_depth, size_t a_head, size_t a_indent, std::vector<std::unique_ptr<ast::t_node>>& a_nodes);
	void f_expressions(size_t a_depth, size_t a_head, std::vector<std::unique_ptr<ast::t_node>>& a_nodes);
	std::unique_ptr<ast::t_nodes> f_options(size_t a_depth, size_t a_head);
	std::unique_ptr<ast::t_node> f_body(size_t a_depth, size_t a_head, size_t a_indent);
