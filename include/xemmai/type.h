...
struct t_type_of<t_object>
{
	...
	static void f_construct(t_object* a_module, const t_value& a_self, size_t a_n);
	static void f_initialize(t_object* a_module, const t_value& a_self, size_t a_n);
	...
	XEMMAI__PORTABLE__EXPORT virtual void f_construct(t_object* a_class, size_t a_n);
	XEMMAI__PORTABLE__EXPORT virtual void f_instantiate(t_object* a_class, size_t a_n);
	...
	XEMMAI__PORTABLE__EXPORT virtual void f_hash(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_call(t_object* a_this, const t_value& a_self, size_t a_n);
	XEMMAI__PORTABLE__EXPORT virtual void f_get_at(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_set_at(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_plus(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_minus(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_not(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_complement(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_multiply(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_divide(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_modulus(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_add(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_subtract(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_left_shift(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_right_shift(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_less(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_less_equal(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_greater(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_greater_equal(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_equals(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_not_equals(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_and(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_xor(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_or(t_object* a_this);
	XEMMAI__PORTABLE__EXPORT virtual void f_send(t_object* a_this);
};
