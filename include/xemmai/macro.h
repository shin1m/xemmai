...
#define XEMMAI__MACRO__REVERSE_REPEAT_0(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_1(macro) macro(0) XEMMAI__MACRO__REVERSE_REPEAT_0(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_2(macro) macro(1) XEMMAI__MACRO__REVERSE_REPEAT_1(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_3(macro) macro(2) XEMMAI__MACRO__REVERSE_REPEAT_2(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_4(macro) macro(3) XEMMAI__MACRO__REVERSE_REPEAT_3(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_5(macro) macro(4) XEMMAI__MACRO__REVERSE_REPEAT_4(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_6(macro) macro(5) XEMMAI__MACRO__REVERSE_REPEAT_5(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_7(macro) macro(6) XEMMAI__MACRO__REVERSE_REPEAT_6(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_8(macro) macro(7) XEMMAI__MACRO__REVERSE_REPEAT_7(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_9(macro) macro(8) XEMMAI__MACRO__REVERSE_REPEAT_8(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_10(macro) macro(9) XEMMAI__MACRO__REVERSE_REPEAT_9(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_11(macro) macro(10) XEMMAI__MACRO__REVERSE_REPEAT_10(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_12(macro) macro(11) XEMMAI__MACRO__REVERSE_REPEAT_11(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_13(macro) macro(12) XEMMAI__MACRO__REVERSE_REPEAT_12(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_14(macro) macro(13) XEMMAI__MACRO__REVERSE_REPEAT_13(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_15(macro) macro(14) XEMMAI__MACRO__REVERSE_REPEAT_14(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT_16(macro) macro(15) XEMMAI__MACRO__REVERSE_REPEAT_15(macro)
#define XEMMAI__MACRO__REVERSE_REPEAT(macro, n) XEMMAI__MACRO__CONCATENATE(XEMMAI__MACRO__REVERSE_REPEAT_, n)(macro)
