...
void t_type_of<t_client>::f_construct(t_object* a_class, t_slot* a_stack, size_t a_n)
{
	t_construct_with<t_transfer (*)(t_object*), t_client_wrapper::f_construct>::f_call(a_class, a_stack, a_n);
}
...
void t_type_of<t_server>::f_construct(t_object* a_class, t_slot* a_stack, size_t a_n)
{
	t_construct<t_server>::f_call(a_class, a_stack, a_n);
}
