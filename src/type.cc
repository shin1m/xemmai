...
void t_type::f_define()
{
	...
	t_define{global}
	(global->f_symbol___initialize(), static_cast<t_object*>(global->v_initialize_validate))
	(global->f_symbol___call(), not_supported)
	...
	(global->f_symbol___get_at(), not_supported)
	(global->f_symbol___set_at(), not_supported)
	(global->f_symbol___plus(), not_supported)
	(global->f_symbol___minus(), not_supported)
	(global->f_symbol___complement(), not_supported)
	(global->f_symbol___multiply(), not_supported)
	(global->f_symbol___divide(), not_supported)
	(global->f_symbol___modulus(), not_supported)
	(global->f_symbol___add(), not_supported)
	(global->f_symbol___subtract(), not_supported)
	(global->f_symbol___left_shift(), not_supported)
	(global->f_symbol___right_shift(), not_supported)
	(global->f_symbol___less(), not_supported)
	(global->f_symbol___less_equal(), not_supported)
	(global->f_symbol___greater(), not_supported)
	(global->f_symbol___greater_equal(), not_supported)
	(global->f_symbol___equals(), t_member<bool(*)(const t_pvalue&, const t_pvalue&), f__equals>())
	(global->f_symbol___not_equals(), t_member<bool(*)(const t_pvalue&, const t_pvalue&), f__not_equals>())
	(global->f_symbol___and(), not_supported)
	(global->f_symbol___xor(), not_supported)
	(global->f_symbol___or(), not_supported)
