...
{
	t_define{a_library}
	(L"close"sv, t_member<void(io::t_file::*)(), &io::t_file::f_close>())
	(L"seek"sv, t_member<intptr_t(io::t_file::*)(intptr_t, int), &io::t_file::f_seek>())
	(L"read"sv, t_member<intptr_t(io::t_file::*)(t_bytes&, size_t, size_t), &io::t_file::f_read>())
	(L"write"sv, t_member<size_t(io::t_file::*)(t_bytes&, size_t, size_t), &io::t_file::f_write>())
