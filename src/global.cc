...
v_type_thread(a_type_thread)
{
	...
	t_type::f_define(v_type_object.f_object());
	xemmai::f_as<t_type&>(v_type_object).v_builtin = true;
	xemmai::f_as<t_type&>(v_type_object).v_primitive = true;
	a_module->f_put(t_symbol::f_instantiate(L"Class").f_object(), v_type_class);
	xemmai::f_as<t_type&>(v_type_class).v_builtin = true;
	a_module->f_put(t_symbol::f_instantiate(L"Module").f_object(), v_type_module);
	xemmai::f_as<t_type&>(v_type_module).v_builtin = true;
	t_fiber::f_define(v_type_fiber.f_object());
	xemmai::f_as<t_type&>(v_type_fiber).v_builtin = true;
	t_thread::f_define(v_type_thread.f_object());
	xemmai::f_as<t_type&>(v_type_thread).v_builtin = true;
	t_symbol::f_define(v_type_symbol.f_object());
	...
	a_module->f_put(t_symbol::f_instantiate(L"Native").f_object(), v_type_native);
